...
export function Checkout(props) {
  ...
  return (
    <section className="section form">
      <h2 className="secton-title">checkout</h2>
...
const StripWrapper = () => {
  return (
    <StripeProvider apiKey="pk_test_51HOjiGG5SO2AW7cgjkBthFX3wu1jsbnrfKqrLIWTTBe4VU8GrlDTzp2Wx49MMNA07LfzqZMz589HDbpPHRRK2MS900SzO3DOV6">
      <Elements>
        <CardForm></CardForm>
      </Elements>
    </StripeProvider>
